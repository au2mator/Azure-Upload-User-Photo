...
$GraphAPICred_File = "AzureADCreds.xml"
...
try {
    ...
    try {
        Write-au2matorLog -Type INFO -Text "Get User UPN from selected User"
        $UPN = (Get-ADUser -Identity $c_User).UserPrincipalName
        Write-au2matorLog -Type INFO -Text "Got the UPN: $UPN"
        ...
        try {
            ...
            $au2matorReturn = "Photo was uploaded for User $UPN"
            $AdditionalHTML = "Photo was uploaded for User $UPN
        <br>
            "
            $Status = "COMPLETED"
            ...
            Write-au2matorLog -Type ERROR -Text "Could not upload the Photo"
            Write-au2matorLog -Type ERROR -Text "Error: $Error"

            $au2matorReturn = "Could not upload the Photo, Error: $Error"
            $AdditionalHTML = "Could not upload the Photo
        <br>
        Error: $Error
            "
            $Status = "ERROR"
        ...
        Write-au2matorLog -Type ERROR -Text "Could not find the User UPN"
        Write-au2matorLog -Type ERROR -Text "Error: $Error"

        $au2matorReturn = "Could not find the User UPN, Error: $Error"
        $AdditionalHTML = "Could not find the User UPN
        <br>
        Error: $Error
            "
        $Status = "ERROR"
    ...
    Write-au2matorLog -Type ERROR -Text "Error on connecting to Microsoft Azure, Error: $Error"
    Write-au2matorLog -Type ERROR -Text "Error on connecting to Microsoft Azure: $Error"

    $au2matorReturn = "Error on connecting to Microsoft Azure, Error: $Error"
    $AdditionalHTML = "Error on connecting to Microsoft Azure
        <br>
        Error: $Error
            "
    $Status = "ERROR"
